...
@section('content')
  <form class="form-horizontal" method="POST" action="{{url('registerProccess')}}">
    <div class="row">
      <div class="col-lg-6">
          ...
          <form class="form-horizontal" method="POST" action="{{url('registerProccess')}}">
            <fieldset>
              ...
              <div class="form-group">
                <label for="inputRekNo" class="col-lg-12 control-label">Link Afiliasi :</label>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="password" name="password" class="form-control" id="inputPassword" placeholder="Password" value="{{ $user->password }}" />
                </div>
              </div>

              <div class="form-group">
                <label for="inputPassword" class="col-lg-2 control-label">Ulangi</label>
                <div class="col-lg-10">
                  <input type="password" name="password_confirm" class="form-control" id="inputPassword" placeholder="Password" value="{{ $user->password }}" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="address1" class="form-control" id="inputAddress1" placeholder="Alamat" value="{{ $user->address1 }}" />
                </div>
              </div>
