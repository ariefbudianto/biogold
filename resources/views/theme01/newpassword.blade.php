  ...
  <div class="row centered-form">
    <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
      <div class="panel panel-default">
        ...
        <h3 class="panel-title">Input Password Baru</h3>
        </div>
        <div class="panel-body">
          ...
          @endif
            <form role="form" method="POST" action="{{ route('user.updatepassword',['id'=>$id, 'code'=>$code]) }}">
              ...
              <button type="submit" name="aksi" class="btn btn-info btn-block"> Update Password Baru</button>
            </form>
